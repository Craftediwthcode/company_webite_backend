document.getElementById("sa-basic").addEventListener("click", function() {
  ...
  .getElementById("sa-long-content")
  ...
  .getElementById("sa-custom-position")
  .addEventListener("click", function() {
    Swal.fire({
      position: "top-end",
      icon: "success",
  ...
  .addEventListener("click", function() {
    Swal.fire({
      ...
      icon: "info",
      html:
        'You can use <b>bold text</b>, <a href="//myrathemes.com/">links</a> and other HTML tags',
      showCloseButton: !0,
      showCancelButton: !0,
