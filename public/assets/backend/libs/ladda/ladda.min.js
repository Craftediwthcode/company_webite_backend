  ...
  function a(a) {
    if (void 0 !== a) {
      if (
        ...
        (u.className =
          "ladda-label"), (n = a), (i = u), (r = document.createRange()).selectNodeContents(
          n
        ), r.surroundContents(i), n.appendChild(i);
      }
      var n,
        i,
        r,
      ...
      var F = {
        start: function() {
          return d ||
            ...
            })(a)), (a.disabled = !0), a.setAttribute(
            "data-loading",
            ""
          ), clearTimeout(o), d.spin(s), this.setProgress(0), this;
        },
        ...
        remove: function() {
          clearTimeout(o), (a.disabled = !1), a.removeAttribute(
            "data-loading"
          ), d && (d.stop(), (d = null)), e.splice(e.indexOf(F), 1);
        }
      };
      return e.push(F), F;
    }
