        ...
        <div class="col-12">
            <div class="card">
                <form class="form-horizontal" id="PageForm">
                    ...
                    <input type="hidden" name="title_id" id="title_id" value="{{ $module_data->id }}">
                    <div class="card-body">
                        <div class="mb-2 row">
                            <div class="col-md-6">
...
@push('js')
    ...
    <script>
        let isImageRequired = @json($module_data->image ? false : true);
        let isBannerImageRequired = @json($module_data->banner_image ? false : true);
        $(document).ready(function() {
            ...
            $('#PageForm').validate({
                rules: {
                    ...
                    banner_image: {
                        required: isBannerImageRequired,
                        extension: "jpeg,png,jpg",
                        maxlength: 2048
                    },
                    description: {
                ...
                messages: {
                    seo_url: {
                        required: "{{ __('The seo url field is required.') }}",
                    },
                    title: {
                ...
                submitHandler: function(form, event) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('page.update',$module_data->id) }}",
                        type: "POST",
                        dataType: 'json',
